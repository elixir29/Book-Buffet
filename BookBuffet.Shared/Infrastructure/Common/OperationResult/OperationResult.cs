...
namespace BookBuffet.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public NagarroSampleValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, NagarroSampleValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(NagarroSampleValidationResult validationResult)
        {
